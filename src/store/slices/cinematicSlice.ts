...
interface CinematicData {
  cinematicToPlayName: CinematicName; // Qué cinemática se reproduce si cambiamos el estado generar a "cinematic". Nos permite buscarla en "allCinematicsData".
